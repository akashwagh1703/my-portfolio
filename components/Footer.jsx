...
import { CONTACTS, NAME, SOCIAL_LINKS } from '../constants/constants'
    ...
    return (
        <div id='intro' className="mt-4 mb-10 lg:mb-0">
            <div className="flex h-10 items-center justify-between text-xs font-normal text-LightGray py-4 px-2 md:px-4 w-full bg-MidNightBlack">
                ...
                <div className="flex items-center">
                    <a href={SOCIAL_LINKS.LINKEDIN} target="_blank" rel="noreferrer">Made with ❤️ by <span className='font-bold'>{NAME}</span></a>
                </div>
